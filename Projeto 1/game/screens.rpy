...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("INICIAR JOGO") action Start()
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            textbutton _("TUTORIAL") action ShowMenu("help")
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("")
            text _("Owner: Isabela Lopes Pena Carneiro")
            text _("Desenvolvido por VR CodeStudio")
            text _("Projeto 'Jogo de KEI' tem como objetivo a conscientizar e melhorar a nota de KEI da operação ML 2022")
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("Salvamento automático"), quick=_("Salvamento rápido"))
